...
let calcCalMag = [calAtingir, teorCao, fonteFosf, fonteCalMag, prnt, custoCalMag, fosfAtingir, eficFosf, teorFosf, teorCal, teorMag, teorPot, teorHAL];
...
function corrigeCalMag() {
    ...
    if(fonteFosf.value == 1 || fonteFosf.value == 5) {
      ...
      resultadoFosf = ((memCalc * 100) / 18.5);
      ...
      resultadoFosf = ((memCalc * 100) / 18); // valor da fonte de fósforo estática
    ...
    if(calAtingir.value == "" || prnt.value == "" || teorCal.value == "" || custoCalMag.value == "" ) {
      ...
      if(qntAplicarCalMag.value < 0) {
        qntAplicarCalMag.value = 0;
        custoAplicarCalMag.value = 0;
      } else {
